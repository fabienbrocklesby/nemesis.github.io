...
function setupScene() {
	...
	var materials = [
	                 new t.MeshLambertMaterial({color: 0x999999}),
	                 new t.MeshLambertMaterial({color: 0x999999}),
	                 new t.MeshLambertMaterial({color: 0x999999}),
	                 ];
...
function addAI() {
	...
	var aiMaterial = new t.MeshBasicMaterial({color: 0x8B0000});
...
function getAIpath(a) {
	...
	do { // Cop-out
		do {
			var x = getRandBetween(0, mapW-5);
			var z = getRandBetween(0, mapH-5);
